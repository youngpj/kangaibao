    ...
    var $message = {
        alert: function(title, content, _callback, btnTxt) {
            ...
            var contentStyle = {
                ...
                fontSize: '0.39436619718309857rem',
                paddingBottom: '20px'
            }
        ...
        confirm: function(title, content, _callback, yesTxt, noTxt) {
            var $modal = document.createElement('DIV');
            var $overlay = createOverlay();
            var $dialog = document.createElement('DIV');
            yesTxt = yesTxt || '确定';
